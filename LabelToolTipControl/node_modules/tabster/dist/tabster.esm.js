  ...
  constructor(tabster) {
    ...
    this._restoreFocus = (source, sourceId) => {
      ...
      const getId = element => {
        ...
        const restorerProps = (_b = (_a = getTabsterOnElement(this._tabster, element)) === null || _a === void 0 ? void 0 : _a.restorer) === null || _b === void 0 ? void 0 : _b.getProps(); // We return id or undefined if there is actual restorer on the element,
