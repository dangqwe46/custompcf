...
function Run() {
    ...
    var version = (0, PackageVersionUtils_1.getPackageVersion)('pcf-start', process.cwd()) || '0.0.1';
    var telemetryClient = (0, apptelemetryclient_1.setupAppInsightsAndClient)('pcf-start', version, telemetryEnv);
...
function RunTask() {
    ...
    if (!codePath || codePath === true) {
        ...
        console.error("The specified codePath '".concat(codePath, "' does not exist."));
        return 400;
    }
    // Start server
    bs.init({
