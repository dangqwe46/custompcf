...
function setupAppInsightsAndClient(productName, productVersion, environment, logger) {
    ...
    devLogger === null || devLogger === void 0 ? void 0 : devLogger.warn("[AppTelemetryClient] SessionId: '".concat(sessionId, "'. UserId: ").concat(userSettings.uniqueId, "; productVersion: '").concat(productVersion, "'"));
...
var AppTelemetryClient = /** @class */ (function () {
    ...
    AppTelemetryClient.prototype.reportSwallowedError = function (methodName, error) {
        var _a;
        (_a = this._logger) === null || _a === void 0 ? void 0 : _a.warn("[AppTelemetryClient] unexpected error occured in method '".concat(methodName, "': ").concat(error));
    };
